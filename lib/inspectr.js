...
let broadcastUrl = process.env.INSPECTR_BROADCAST_URL || 'http://localhost:4004/api/sse';

// Optionally, update the broadcast URL if needed.
function setBroadcastUrl(url) {
  broadcastUrl = url;
  console.log(`🔧 Using Inspectr SSE Endpoint ${broadcastUrl}`);
}
